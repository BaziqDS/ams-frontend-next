...
export const config = {
  matcher: ["/users/:path*", "/roles/:path*", "/locations/:path*", "/categories/:path*", "/items/:path*", "/stock-entries/:path*", "/employees/:path*", "/stock-registers/:path*", "/reports/:path*", "/inspections/:path*", "/maintenance/:path*"],
};
