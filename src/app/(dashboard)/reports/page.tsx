            ...
            <details className={styles.filterDisclosure} open={filtersOpen} onToggle={event => setFiltersOpen(event.currentTarget.open)}>
              ...
              {isInventoryStockReport ? (
                ...
                <div className={styles.filters}>
                  ...
                  <div className={styles.filterActions}><button type="button" className="btn btn-primary" onClick={loadReport} disabled={loading}>Apply Filters</button><button type="button" className="btn" onClick={() => setAssetFilters({ sourceLocation: "", person: "", targetLocation: "", itemQuery: "", status: "", allocatedFrom: "", allocatedTo: "", inspectionWise: false })}>Clear</button></div>
                </div>
              ) : isMovementLedger ? (
                <div className={styles.filters}>
